...
<div class="ml-[240px] p-4">
  <div class="h-screen w-full">
    <div class="flex h-12 w-full items-center justify-center gap-4">
      ...
      <button
          class="flex items-center rounded-sm bg-sky-600 px-4 py-2 text-white hover:bg-sky-500 active:bg-sky-400">modify
        &nbsp;
        <svg class="size-3 stroke-white fill-white" version="1.1" viewBox="0 0 18 18"
             xmlns="http://www.w3.org/2000/svg">
          <desc/>
          <defs/>
